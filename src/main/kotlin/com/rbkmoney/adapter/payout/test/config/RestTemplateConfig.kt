...
import com.rbkmoney.adapter.payout.test.config.properties.RestTemplateProperties
...
class RestTemplateConfig(private val properties: RestTemplateProperties) {
    ...
    fun restTemplate(restTemplateBuilder: RestTemplateBuilder): RestTemplate {
        val restTemplate = restTemplateBuilder
            ...
            .build()
            .apply {
                errorHandler = getDefaultResponseErrorHandler()
            }
    ...
    private fun getDefaultResponseErrorHandler() =
        object : DefaultResponseErrorHandler() {
            override fun hasError(statusCode: HttpStatus) = false
        }
}
